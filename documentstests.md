...
Метод [ASSERT_EQ]
Тест №1
Цель: Проверить возвращаемое значение, когда два корень
Входные данные: 1,3,1,&x1,&x2
...
Метод [ASSERT_EQ]
Тест №1
Цель: Проверить возвращаемое значение, когда один корень
...
Метод [ASSERT_EQ]
Тест №1
Цель: Проверить возвращаемое значение, когда на вход получаем линейное уравнение
Входные данные: 0,1,2,&x1,&x2
Ожидаемый результат: 1
Описание процесса: Необходимо создать x1 и x2 для работы функции
...
Метод [ASSERT_EQ]
Тест №1
Цель: Проверить возвращаемое значение, когда нет корней
Входные данные: 1,1,4,&x1,&x2
Ожидаемый результат: -1
Описание процесса: Необходимо создать x1 и x2 для работы функции
