[![CI/CD GitHub Actions](https://github.com/Snoake1/Test1/actions/workflows/test-action.yml/badge.svg)](https://github.com/seekerk/gtest/actions/workflows/test-action.yml)
